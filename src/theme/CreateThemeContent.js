    ...
    const getThemeObj = () => {
        ...
        themeObj[_.camelCase(state.themeName)] = {
            ...
            "colors": {
                ...
                "card": {
                    "text": state.cardBgColor,
                    "background": state.cardTxtColor
                },
                "link": {
    ...
    <>
        <Container>
            <Section>
                ...
                <Row>
                    <label htmlFor="btn_bg_color">Card Background Color:</label> {' '}
                    <input type="color" id="card_bg_color" name="cardBgColor" value={ state.cardBgColor } onChange={ handleChange }/>
                </Row>
                <Row>
                    <label htmlFor="btn_txt_color">Card Text Color:</label> {' '}
                    <input type="color" id="card_txt_color" name="cardTxtColor" value={ state.cardTxtColor } onChange={ handleChange }/>
                </Row>
                <Row>
            ...
            <Section>
                ...
                <Preview style={{backgroundColor: state.bgColor, color: state.txtColor, fontFamily: state.font}}>
                    ...
                    <div style={{backgroundColor:state.cardBgColor, color:state.cardTxtColor, fontFamily: state.font}}>
                            This is a note 
                    </div>
